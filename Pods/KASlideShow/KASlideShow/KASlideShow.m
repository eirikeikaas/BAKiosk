...
- (void) addImage:(NSString*) image
{
    ...
    if([self.images count] == 1){
        _topImageView.image = [UIImage imageWithContentsOfFile:[[NSBundle mainBundle] pathForResource:image ofType:@"jpg"]];
    }else if([self.images count] == 2){
        _bottomImageView.image = [UIImage imageWithContentsOfFile:[[NSBundle mainBundle] pathForResource:image ofType:@"jpg"]];
    }
}
...
- (void) next
{
    if(! _isAnimating){
        ...
        _topImageView.image = [UIImage imageWithContentsOfFile:[[NSBundle mainBundle] pathForResource:self.images[_currentIndex] ofType:@"jpg"]];
        _bottomImageView.image = [UIImage imageWithContentsOfFile:[[NSBundle mainBundle] pathForResource:self.images[nextIndex] ofType:@"jpg"]];
...
- (void) previous
{
    if(! _isAnimating){
        ...
        _topImageView.image = [UIImage imageWithContentsOfFile:[[NSBundle mainBundle] pathForResource:self.images[_currentIndex] ofType:@"jpg"]];
        _bottomImageView.image = [UIImage imageWithContentsOfFile:[[NSBundle mainBundle] pathForResource:self.images[prevIndex] ofType:@"jpg"]];
